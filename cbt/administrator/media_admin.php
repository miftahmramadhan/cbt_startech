...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_5">
			...
			<a id="site-title" href="dashboard.html"><span>ADMINISTRATOR</span><br><span>Computer Based Training STARTECH .ID</span></a>
		</div>
...
<footer id="bottom">
	<section class="container_12 clearfix">
		...
		<div class="grid_6 alignright">
			&nbsp; &nbsp; &nbsp; Copyright &copy; 2015 <a href="#">STARTECH .ID</a>
		</div>
	</section>
</footer>
